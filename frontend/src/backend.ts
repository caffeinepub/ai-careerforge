...
export class Backend implements backendInterface {
    ...
    async getAllStudents(): Promise<Array<[Principal, Student]>> {
    ...
    async getStudent(arg0: Principal): Promise<Student | null> {
        if (this.processError) {
            try {
    ...
    async getStudentRecordKey(): Promise<Principal> {
        if (this.processError) {
            try {
                const result = await this.actor.getStudentRecordKey();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
